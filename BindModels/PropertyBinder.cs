...
namespace Kesco.Lib.BaseExtention.BindModels
{
    ...
    public class PropertyBinder : IBinderValue<string>
    {
        ...
        public string GetPropertyValue()
        {
            ...
            if (_propertyType == typeof(DateTime?))
            {
                return ((DateTime?)val).Value.ToString("dd.MM.yyyy");
            }
        ...
        private void SetPropertyValue(string value)
        {
            ...
            {
                throw new ArgumentException("В классе PropertyBinder, передоваемое значение неизвестного типа. Необходимо добавить обработку типа: " + type);
            }
