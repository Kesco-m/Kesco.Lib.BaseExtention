...
namespace Kesco.Lib.BaseExtention
{
    ...
    public static class ObjectDeepCloner
    {
        ...
        /// </summary>
        /// <remarks>
        /// Чтобы класс клонировался быстро(через сериализацию) необходимо все классы(основной, вложенные и используемые) пометить атрибутом [Serializable]
        ...
        public static T DeepClone<T>(T source)
        {
            ...
            {
                return CloneBySerializing(source);
            }
